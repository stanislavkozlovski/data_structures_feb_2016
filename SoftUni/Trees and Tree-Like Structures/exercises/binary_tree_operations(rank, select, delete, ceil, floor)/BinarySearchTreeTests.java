...
public class BinarySearchTreeTests {
    ...
    public void testSelect() {
        ...
        Assert.assertEquals(bst.select(3), Integer.valueOf(18));
        Assert.assertEquals(bst.select(2), Integer.valueOf(16));
        Assert.assertEquals(bst.select(1), Integer.valueOf(15));
        Assert.assertEquals(bst.select(0), Integer.valueOf(3));
        Assert.assertEquals(bst.select(5), Integer.valueOf(30));
        Assert.assertEquals(bst.select(4), Integer.valueOf(25));
        Assert.assertEquals(bst.select(6), Integer.valueOf(40));
    }
}
